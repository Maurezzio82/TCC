...
for i_episode in range(num_episodes):    
    ...
    for t in count():
        ...
        q_val = optimize_model()  # <--- modify optimize_model to return mean Q-value
